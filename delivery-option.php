            ...
            <div class="col-md-12">
                <div class="fieldset">                    
                    ...
                    <div class="row">
                        <div class="col-md-3"></div>
                            <div class="col-md-6">
                                <button type="button" class="swift-btn btn btn-primary btn-lg btn-block">Swift Delivery</button>
                                <button type="button" class="regular-btn btn btn-primary btn-lg btn-block">Regular Delivery</button>
                                <button type="button" class="same-btn btn btn-primary btn-lg btn-block">Same Day Delivery</button>
                            </div>
                        </div> 
                    </div>
                </div>
                ...
                <div class="fieldset">
                    <div class="delivery_details">
                        <form class="text-center border border-light" action="#!">
                            <p class="h4 mb-4 pick-head">Delivery Details</p>
